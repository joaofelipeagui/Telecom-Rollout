...
export function Sidebar({ user, onLogout, projectId }: Props) {
  ...
  return (
    <div className="w-16 hover:w-52 group transition-all duration-200 flex-shrink-0 bg-gray-900 border-r border-gray-800 flex flex-col h-screen sticky top-0 overflow-hidden">
      {/* Logo */}
